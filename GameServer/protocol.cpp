...
void GameProtocol::CSPJoinIdPassRequest(PMSG_IDPASS* lpMsg, int aIndex)
{
	...
	{
		g_Log.AddC(TColor::Red, "[IP: %s][aIndex: %d] connecting with DLL for different Game Season, review and correct (if required) %s", gObj[aIndex].m_PlayerData->Ip_addr, aIndex, lpMsg->ServerSeason);
