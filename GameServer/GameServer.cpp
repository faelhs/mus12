...
BOOL GameServerStart(void) 
{
	...
	g_Log.Add("Created and developed by IGC-Network and released by MuEMU");
		...
		case WM_COMMAND:
			...
			switch (wmId)
			{
				...
				case ID_LICENSE_DELETELICENSE:
					{
						if(MessageBox(hWnd, "It will delete license data from your computer! After that, GameServer will be closed. Proceed?", "WARNING", MB_ICONWARNING|MB_YESNO) == IDYES)
						{
							HKEY hKey;
